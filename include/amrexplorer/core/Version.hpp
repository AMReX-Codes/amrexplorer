...
// What --version prints after the program name: the version, and for a
// development version the commit it came from, in parentheses. gitDescribe is
...
// release version never carries it: the version already is the tag.

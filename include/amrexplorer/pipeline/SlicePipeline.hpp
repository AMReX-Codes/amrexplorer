...
// Renders an already-open local or remote session using the same initial/frame
// pipeline. This is the remote open path and avoids a second metadata read or
// a client-side filesystem dependency.
